...
namespace cs296
{
  ...
  {	//ground
    	...
    	{
    	  b2EdgeShape shape;
      	  shape.Set(b2Vec2(-90.0f, -12.0f), b2Vec2(-16.0f, -12.0f));
      	  b2EdgeShape shape1;
      	  shape1.Set(b2Vec2(-10.2f, -12.0f), b2Vec2(90.0f, -22.0f));
      	  b2EdgeShape shape2;
  	...
  	{   float xm,ym;
        ...
        b2Body* ground4;
        {
		    b2Body* ground = NULL;
		    {
		    	...
		    	b2PolygonShape shape;
		    	shape.SetAsBox(0.1f,0.3f);//tested this
		    ...
		    {
		    	b2PolygonShape shape;
		    	shape.SetAsBox(0.1f,0.3f); //testing this
